...
resource "aws_s3_bucket" "example_bucket" {
  bucket = "cdp-example-bucket-name"
}
...
# S3 Bucket for CloudFront Origin
resource "aws_s3_bucket" "example_bucket" {
  bucket = "example-cloudfront-origin-bucket"
  acl    = "public-read"
...
resource "aws_s3_bucket" "b" {
  bucket = "cdp-mybucket-unique"  # Change to a unique bucket name
...
resource "aws_cloudfront_origin_access_control" "default" {
  ...
  signing_protocol              = "sigv4"  # Required argument
}
...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  logging_config {
    ...
    bucket          = "mylogs.s3.amazonaws.com"  # Change to your logging bucket
    prefix          = "myprefix"
  }
